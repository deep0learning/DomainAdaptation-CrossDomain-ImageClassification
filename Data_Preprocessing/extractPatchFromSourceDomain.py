...
def initialization(fileList, ctFilePath, diseaseFilePath, segmentationFilePath, picklePath):
    for i in range(len(fileList)):
        ...
        _seg_volume = readCTVolume(segmentationFilePath, fileList[i][:fileList[i].find('.')] + '_Seg.nii.gz')
...
if __name__ == '__main__':
    ctFilePath = '../Domain_Adaptation_Data/sourceDomain/AnaData/'
    diseaseMaskFilePath = '../Domain_Adaptation_Data/sourceDomain/NII-files/'
    lungSegMaskFilePath = '../Domain_Adaptation_Data/sourceDomain/LungSegManualMask/'

    picklePath = '../Data_SourceDomain_PKL/'
